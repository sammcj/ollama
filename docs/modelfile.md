...
| cache_type_k    Sets the K/V cache quantization type for keys. (Default: f16)                                                                                                                                                                                            | string     | cache_type_k f16     |
| cache_type_v    Sets the K/V cache quantization type for values. (Default: f16)                                                                                                                                                                                          | string     | cache_type_v f16     |
